...
import { featureItems, programs } from '@/components/constants'
			...
			<div className='w-full h-screen flex items-center'>
				<div className='max-w-xl ml-60 flex h-full flex-col justify-center'>
					...
					<p className='text-muted-foreground'>
						...
						necessitatibus ipsa soluta eius qui corrupti, at, laborum
						exercitationem quis temporibus quidem repellat ipsum dolore omnis
						cupiditate aliquid ut? Fuga, explicabo.
					</p>
					{user ? (
